...
class Goods(models.Model):
    ...
    id_goods = models.AutoField(primary_key=True, blank=True, null=True)
...
class Profile(models.Model):
    ...
    promo_profile = models.TextField(blank=True, null=True)
...
class Setting(models.Model):
    ...
    salse_promo = models.IntegerField(blank=True, null=True)
...
class Zakaz(models.Model):
    ...
    id_order = models.AutoField(primary_key=True, blank=True, null=True)
